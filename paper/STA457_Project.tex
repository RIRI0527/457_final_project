...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, sharp corners, enhanced, breakable, frame hidden, interior hidden]}{\end{tcolorbox}}\fi
...
the range \([350, 450]\), and the MAPE is in the range \([5%, 6%]
